...
class NimAI():
    ...
    def best_future_reward(self, state):
        ...
        # Calculate Q-value for each available action and return the max
        q_values = []
    ...
    def choose_action(self, state, epsilon=True):
        ...
        # Greedy strategy: Choose best action based on Q-values
        q_values = [self.get_q_value(state, action) for action in available_actions]
        max_q = max(q_values)

        # Collect all actions that have the max Q-value (to handle ties)
